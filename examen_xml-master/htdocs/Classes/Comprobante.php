...
class Comprobante extends XML
{
    function __construct()
    {
        ...
        $this->atributos['NoCertificado'] = '00000010101010101';
        ...
        $this->atributos['Moneda'] = 'MXN';
        $this->atributos['Total'] = '116';
        $this->atributos['MetodoPago'] = 'PUE';
        $this->atributos['FormaPago'] = '01';
        $this->atributos['TipoDeComprobante'] = 'i';
        $this->atributos['LugarExpedicion'] = '64000';
